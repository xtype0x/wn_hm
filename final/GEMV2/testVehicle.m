...
% commPairVeh1 = vehicleMidpoints(1,:);
% commPairVeh2 = vehicleMidpoints(2,:);
...
attenuation = LOSNLOS.obstacleAttenuation(Rxheight,Rxheight,driverHeight,...
				20.0,19,SignalFrequency)
