...
attenuation = LOSNLOS.bodyShadowing(vehicleMidpoints(1:3,:),vehicleMidpoints(200:202,:),vehiclesHeight(1:3,:),...
	vehiclesHeight(200:202,:),1.46,2.4*10^9);
