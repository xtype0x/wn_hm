...
scooterMeanHeight = 1.46;
scooterStdDev =.05;
carMeanHeight = 1.5; 
carStdDev = .1;

scooterMeanWidth = .68;
scooterStdDevWidth = .02;
carMeanWidth = 1.75;
carStdDevWidth = .1;

scooterMeanLength = 1.85;
scooterStdDevLength = .05;
carMeanLength = 5;
carStdDevLength = .4;

% Putting vehicle dimensions in an array for more compact argument passing 
vehDimensionParams = ...
    [scooterMeanHeight     scooterStdDev        carMeanHeight     carStdDev;...
     scooterMeanWidth      scooterStdDevWidth   carMeanWidth      carStdDevWidth;...
     scooterMeanLength     scooterStdDevLength  carMeanLength     carStdDevLength];
